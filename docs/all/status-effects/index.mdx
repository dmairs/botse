...
| <img src="/icons/fear.svg" alt="Fear Icon" /> | [Fear](/docs/all/status-effects/fear) | The effects of this unit's non-Combat skills are ignored. This effect does not apply to skill dice already in [active slots](/docs/all/glossary/active-slot) or the [cooldown track](/docs/all/glossary/cooldown-track). |
